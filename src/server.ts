...
const server = Bun.serve<WSContext>({
    port: PORT,
    hostname: "127.0.0.1",
    async fetch(req: { url: string | { toString: () => string; }; headers: any; method: string; json: () => { name?: string; } | PromiseLike<{ name?: string; } | null> | null; }) {
    ...
    websocket: {
        open(ws: { subscribe: (arg0: any) => void; data: { userId: any; username: any; }; send: (arg0: string) => void; }) {
        ...
        message(ws: { send: (arg0: string) => void; data: { username: any; userId: string; }; subscribe: (arg0: any) => void; }, message: ArrayBuffer | NodeJS.ArrayBufferView<ArrayBufferLike> | null | undefined) {
        ...
        close(ws: { unsubscribe: (arg0: any) => void; data: { userId: any; username: any; }; }) {

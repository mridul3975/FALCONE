                ...
                <div className="border border-[#2B2448] bg-[rgba(14,10,33,0.92)] p-7 shadow-[0_24px_80px_rgba(0,0,0,0.65)] backdrop-blur-xl sm:p-9">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="flex items-center justify-center gap-3 border border-[#3E3563] bg-[#120E29] px-4 py-3 text-[11px] font-bold tracking-[0.08em] text-[#E4EAF7] uppercase hover:bg-[#1A1538] transition group/google"
                        >
                            <svg className="h-4 w-4 transition-transform group-hover/google:scale-110" viewBox="0 0 24 24">
                                <path
                                    fill="currentColor"
